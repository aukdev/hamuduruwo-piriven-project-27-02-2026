...
public interface PaperRepository extends JpaRepository<Paper, UUID> {
        ...
        Page<Paper> findByPaperTypeAndStatus(@Param("paperType") PaperType paperType,
        ...
        @Query("SELECT p FROM Paper p JOIN FETCH p.subject WHERE p.paperType = :paperType ORDER BY p.createdAt DESC")
        Page<Paper> findByPaperType(@Param("paperType") PaperType paperType, Pageable pageable);
}
